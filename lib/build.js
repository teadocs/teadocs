    ...
    writeHtml() {
        ...
        tagsA.each((i, elem) => {
            ...
            if ( href ) {
                ...
                let rootPath = this.rootPath === "/" ? "" : this.rootPath
                rootPath = rootPath[rootPath.length - 1] === "/" ? rootPath.substring(0, rootPath.length - 1) : rootPath
                if ( href[href.length-1] === "/" ) {
                    href = href + "index"
                }
                $(elem).attr("href", rootPath + href + ".html")
                paths.push({
                    node: $(elem),
                    title: title,
