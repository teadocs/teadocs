 ...
 * convert datetime
 * e.g.   
 * Tue Aug 14 2018 16:55:10 GMT+0800 (GMT+08:00)
 * 
 * result.
 * 2018-08-14 16:55:10
 */
exports.formateDatetime = function (dateStr) {
  ...
  return `${year}-${jointZero(month)}-${jointZero(day)} ${jointZero(hour)}:${jointZero(minute)}:${jointZero(second)}`
}